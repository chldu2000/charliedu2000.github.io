...
根据 [Chapter 2.4](https://www.linuxfromscratch.org/lfs/view/stable/chapter02/creatingpartition.html)，LFS 需要单独的分区，而且比较好的方法是用空的分区或者新建一个分区。WSL 的虚拟磁盘不方便再分，就新建一个好了。
